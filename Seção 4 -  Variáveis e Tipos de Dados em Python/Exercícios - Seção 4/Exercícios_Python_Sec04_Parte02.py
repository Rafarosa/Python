...
print('19. Leia um valor de volume em litros e apresente-o convertido em metros cúbicos m³. A fórmula de conversão é: M = L/1000, sendo L o volume em litros e M o volume em metros cúbicos.')

l2 = float(input('Por gentileza, informe o valor em litros para apresentar a conversão: '))

m2 = l2/1000

print(f'{l2} Litros é igual a {m2:.2f}m³')

print('20. Leia um valor de massa em quilogramas é apresente-o convertido em libras. A fórmula de conversão é: L = K/0,45, sendo K a massa em quilogramas e L a massa em libras.')

kg1 = float(input('Por gentileza, informe o valor em quilogramas para a conversão em Libras: '))

lb1 = kg1/0.45

print(f'{kg1} quilos é igual a {lb1:.2f} Libras')